...
import jp.techacademy.takayuki.ochiai.jumpactiongame.JumpActionGame
...
class AndroidLauncher : AndroidApplication(), ActivityRequestHandler {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // テキストのままだと、"There was a problem getting an ad response. ErrorCode: 0"が表示されないため、"addTestDevice"でエミュレータのデバイスを追加
        // (エミュレータから広告をクリックして不正な収益稼ぎをされないようにするための対策らしい)
//        val adRequest = AdRequest.Builder().build() // 元のコード
